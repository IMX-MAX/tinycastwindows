...
public static class BuiltInCommands
{
    ...
    [
        ...
        new("cmd:camera", "Open Camera", "Capture with the Windows Camera app", EntryKind.Command, Glyph: "📷"),
        new("cmd:calendar", "Open Calendar", "Open your Windows calendar", EntryKind.Command, Glyph: "📅"),
        new("cmd:files", "Search Files", "Find files in chosen folders", EntryKind.Command, Glyph: "📁"),
        new("cmd:calculator-history", "Calculator History", "Recent calculations and conversions", EntryKind.Command, Glyph: "="),
        ...
        new("cmd:quick-actions", "Quick Actions", "Transform selected text with Mistral", EntryKind.Command, Glyph: "✦"),
        new("cmd:backup", "Backup & Restore", "Export or import a .tinycast backup", EntryKind.Command, Glyph: "⇅"),
